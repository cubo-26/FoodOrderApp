...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvSplashTagUIS;
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvSplashTagUIS;
      TextView tvSplashTagUIS = ViewBindings.findChildViewById(rootView, id);
      if (tvSplashTagUIS == null) {
        break missingId;
      }
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, ivSplashLogo, tvSplashName,
          tvSplashTagUIS, tvSplashTagline);
    }
